...
if not os.path.exists(r'C:\DeepLearning\MnistData\out'):
    os.makedirs(r'C:\DeepLearning\MnistData\out')
...
for it in range(20000):
    ...
    if it % 2000 == 0:
        ...
        plt.savefig(r'C:\DeepLearning\MnistData\out/{}.png'.format(str(i).zfill(3)), bbox_inches='tight')
